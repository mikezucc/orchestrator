      ...
      <div className="flex-1 flex items-center justify-center px-4">
        <div className="max-w-md w-full space-y-8">
          <div className="text-center">
            <h1 className="text-2xl font-bold uppercase tracking-wider mb-2 graphite-logo">
              Facet <span>Build</span>
            </h1>
            <p className="text-xs uppercase tracking-wider graphite-text-secondary">
          ...
          <div className="graphite-card p-6 space-y-6 crosshatch-light">
            <div>
              <h2 className="text-lg font-semibold mb-2 graphite-text-primary">Authentication Required</h2>
